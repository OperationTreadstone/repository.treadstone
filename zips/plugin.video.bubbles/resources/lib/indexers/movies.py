...
class movies:
	...
	def __init__(self, type = tools.Media.TypeMovie, kids = tools.Selection.TypeUndefined):
		...
		if type == tools.Media.TypeDocumentary:
			...
			self.category = 'feature,tv_movie'
		...
		self.tm_user = control.setting('accounts.informants.tmdb.api') if control.setting('accounts.informants.tmdb.enabled') else ''
		self.fanart_tv_user = control.setting('accounts.artwork.fanarttv.api') if control.setting('accounts.artwork.fanarttv.enabled') else ''
	...
	def collections(self):
		...
		if not self.kidsOnly() or self.restriction >= 0:
			collections.extend([
				('Disney', 'http://www.imdb.com/search/title?keywords=disney&num_votes=1000,&production_status=released&title_type=feature,tv_movie'),
				('Toy Story', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=toy%20story&title_type=feature,tv_movie'),
				('Land Before Time', 'http://www.imdb.com/search/title?production_status=released&title_type=feature,tv_movie,video&title=land%20before%20time'),
			])
		if not self.kidsOnly() or self.restriction >= 1:
			collections.extend([
				('Harry Potter', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=harry%20potter&title_type=feature,tv_movie'),
				('Star Wars', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=star%20wars&title_type=feature,tv_movie'),
				('Back To The Future', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=back%20to%20the%20future&title_type=feature,tv_movie'),
				('Rocky', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=rocky&title_type=feature,tv_movie&genres=sport'),
				('Karate Kid', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=karate%20kid&title_type=feature,tv_movie'),
				('Narnia', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=narnia&title_type=feature,tv_movie'),
				('Shrek', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=shrek&title_type=feature,tv_movie'),
				('Kung Fu Panda', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=kung%20fu%20panda&title_type=feature,tv_movie'),
				('Alvin and the Chipmunks', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title_type=feature,tv_movie&title=chipmunks'),
			])
		if not self.kidsOnly() or self.restriction >= 2:
			collections.extend([
				('Marvel Comics', 'http://www.imdb.com/search/title?keywords=marvel-comics&num_votes=1000,&production_status=released&title_type=feature,tv_movie'),
				('X-Men', 'http://www.imdb.com/search/title?keywords=marvel-comics&num_votes=1000,&production_status=released&title=x-men&title_type=feature,tv_movie'),
				('Spider-Man', 'http://www.imdb.com/search/title?keywords=marvel-comics&num_votes=1000,&production_status=released&title=spider-man&title_type=feature,tv_movie'),
				('Fantastic Four', 'http://www.imdb.com/search/title?keywords=marvel-comics&num_votes=1000,&production_status=released&title=fantastic%20four&title_type=feature,tv_movie'),
				('Hulk', 'http://www.imdb.com/search/title?keywords=marvel-comics&num_votes=1000,&production_status=released&title=hulk&title_type=feature,tv_movie'),
				('Iron Man', 'http://www.imdb.com/search/title?keywords=marvel-comics&num_votes=1000,&production_status=released&title=iron%20man&title_type=feature,tv_movie'),
				('Captain America', 'http://www.imdb.com/search/title?keywords=marvel-comics&num_votes=1000,&production_status=released&title=captain%20america&title_type=feature,tv_movie'),
				('Thor', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title_type=feature,tv_movie&title=thor'),

				('DC Comics', 'http://www.imdb.com/search/title?keywords=dc-comics&num_votes=1000,&production_status=released&title_type=feature,tv_movie'),
				('Batman', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=batman&title_type=feature,tv_movie'),
				('Superman', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=superman&title_type=feature,tv_movie'),

				('Dark Horse Comics', 'http://www.imdb.com/search/title?keywords=dark-horse-comics&num_votes=1000,&production_status=released&title_type=feature,tv_movie'),
				('Hellboy', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title_type=feature,tv_movie&title=hellboy'),
				('Sin City', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title_type=feature,tv_movie&title=sin%20city'),
				('300', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title_type=feature,tv_movie&title=300'),

				('Middle Earth', 'http://www.imdb.com/search/title?keywords=hobbit&num_votes=1000,&production_status=released&title_type=feature,tv_movie&user_rating=4.0,'),
				('Star Trek', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=star%20trek&title_type=feature,tv_movie'),
				('Matrix', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=matrix&title_type=feature,tv_movie'),
				('Fast And Furious', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=fast%20furious&title_type=feature,tv_movie'),
				('007', 'http://www.imdb.com/search/title?keywords=007&num_votes=1000,&production_status=released&title_type=feature,tv_movie'),
				('James Bond', 'http://www.imdb.com/search/title?keywords=007&num_votes=1000,&production_status=released&title_type=feature,tv_movie'),
				('Jurassic Park', 'http://www.imdb.com/search/title?keywords=jurassic-park&num_votes=1000,&production_status=released&title_type=feature,tv_movie'),
				('Hunger Games', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=hunger%20games&title_type=feature,tv_movie'),
				('Terminator', 'http://www.imdb.com/search/title?genres=action&keywords=the-terminator&num_votes=1000,&production_status=released&title_type=feature,tv_movie'),
				('Rambo', 'http://www.imdb.com/search/title?genres=action&keywords=rambo&num_votes=1000,&production_status=released&title_type=feature,tv_movie'),
				('Mission Impossible', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=mission%20impossible&title_type=feature,tv_movie'),
				('Indiana Jones', 'http://www.imdb.com/search/title?num_votes=1000,&plot=indiana%20jones&production_status=released&role=nm0000148&title_type=feature,tv_movie'),
				('Jason Bourne', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=bourne&title_type=feature,tv_movie'),
				('Twilight', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&role=nm0829576&title=twilight&title_type=feature,tv_movie'),
				('Pirates Of The Caribbean', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=pirates%20caribbean&title_type=feature,tv_movie'),
				('Rush Hour', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=rush%20hour&title_type=feature,tv_movie'),
				('Transformers', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=transformers&title_type=feature,tv_movie'),
				('Ace Ventura', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=ace%20ventura&title_type=feature,tv_movie'),
				('Dan Brown', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&role=nm1467010&title_type=feature,tv_movie'),
				('Ocean\'s', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=oceans&title_type=feature,tv_movie&genres=crime'),
				('Mummy', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=the%20mummy&title_type=feature,tv_movie&genres=fantasy,adventure'),
				('Austin Powers', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=austin%20powers&title_type=feature,tv_movie'),
				('Transporter', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=transporter&title_type=feature,tv_movie'),
				('Taxi', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=taxi&title_type=feature,tv_movie&genres=action,comedy'),
				('Men In Black', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=men%20in%20black&title_type=feature,tv_movie'),
				('Space Odyssey', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&role=nm0002009&title_type=feature,tv_movie'),
				('Godzilla', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=godzilla&title_type=feature,tv_movie'),
				('King Kong', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=king%20kong&title_type=feature,tv_movie'),
				('Planet Of The Apes', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title_type=feature,tv_movie&title=planet%20apes'),
				('Tron', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title_type=feature,tv_movie&title=tron'),
				('Naked Gun', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title_type=feature,tv_movie&title=naked%20gun'),
				('Final Fantasy', 'http://www.imdb.com/search/title?production_status=released&title_type=feature,tv_movie&title=final%20fantasy'),
			])
		if not self.kidsOnly() or self.restriction >= 3:
			collections.extend([
				('Predator', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=predator&title_type=feature,tv_movie&genres=action'),
				('Saw', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=saw&title_type=feature,tv_movie&genres=horror'),
				('The Godfather', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=the%20godfather&title_type=feature,tv_movie&genres=crime,drama'),
				...
				('Alien', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=alien&title_type=feature,tv_movie&genres=sci_fi'),
				('Mad Max', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=mad%20max&title_type=feature,tv_movie'),
				('Blade', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=blade&title_type=feature,tv_movie&genres=horror,action'),
				('Hannibal Lecter', 'http://www.imdb.com/search/title?num_votes=1000,&plot=hannibal%20lecter&production_status=released&title_type=feature,tv_movie&genres=crime'),
				('Harold And Kumar', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=kumar&title_type=feature,tv_movie'),
				('Resident Evil', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=resident%20evil&title_type=feature,tv_movie'),
				('Kill Bill', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=kill%20bill&title_type=feature,tv_movie'),
				('Scream', 'http://www.imdb.com/search/title?num_votes=10000,&production_status=released&title=scream&title_type=feature,tv_movie&genres=horror,mystery'),
				('Die Hard', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=die%20hard&title_type=feature,tv_movie&genres=action'),
				('Lethal Weapon', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=lethal%20weapon&title_type=feature,tv_movie'),
				('Three Colors', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=three%20colors&title_type=feature,tv_movie'),
				('Butterfly Effect', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=butterfly%20effect&title_type=feature,tv_movie'),
				('Beverly Hills Cop', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=beverly%20hill%20cop&title_type=feature,tv_movie'),
				('American Pie', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=american&role=nm0004755&title_type=feature,tv_movie'),
				('Scary Movie', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title=scary%20movie&title_type=feature,tv_movie'),
				('Final Destination', 'http://www.imdb.com/search/title?num_votes=50000,&production_status=released&title=final%20destination&title_type=feature,tv_movie'),
				('Man With No Name', 'http://www.imdb.com/search/title?genres=western&num_votes=1000,&production_status=released&release_date=1964,1966&role=nm0001466&title_type=feature,tv_movie'),
				('Mexico', 'http://www.imdb.com/search/title?keywords=mariachi&production_status=released&release_date=1992,2003&role=nm0001675&title_type=feature,tv_movie&genre=actions,thriller'),
				('Millennium', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&role=nm2297183&title_type=feature,tv_movie'),
				('Halloween', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title_type=feature,tv_movie&title=halloween'),
				('Friday The 13th', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title_type=feature,tv_movie&title=friday%20the%2013th'),
				('Nightmare On Elm Street', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title_type=feature,tv_movie&title=nightmare%20elm'),
				('Chronicles Of Riddick', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title_type=feature,tv_movie&title=riddick'),
				('Paranormal Activity', 'http://www.imdb.com/search/title?num_votes=1000,&production_status=released&title_type=feature,tv_movie&title=paranormal%20activity'),
			])

		collections = sorted(collections, key=lambda x: x[0])

		for i in collections: self.list.append({'name': i[0], 'url': i[1], 'image': 'collections.png', 'action': self.parameterize('movies')})
	...
	def trakt_list(self, url, user):
		...
		for item in items:
			try:
				...
				self.list.append({'title': title, 'originaltitle': title, 'year': year, 'premiered': premiered, 'genre': genre, 'duration': duration, 'rating': rating, 'votes': votes, 'mpaa': mpaa, 'plot': plot, 'imdb': imdb, 'tmdb': tmdb, 'tvdb': '0', 'poster': '0', 'next': next})
			except:
				pass
	...
	def super_info(self, i):
		try:
			...
			try:
				...
				# Bubbles replace poster2 - old bug.
