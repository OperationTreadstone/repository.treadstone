...
class source:
	def __init__(self):
		...
		# [BUBBLESCODE]
		self.enabled = control.setting('accounts.providers.seriesever.enabled') == 'true'
		self.user = control.setting('accounts.providers.seriesever.user')
		self.password = control.setting('accounts.providers.seriesever.pass')
		# [/BUBBLESCODE]
