		...
		try:
			...
			if 'item' in result:
				for item in result['item']:
					...
					jsonPassword = False
					jsonAge = None
					if 'newznab:attr' in item:
						for attribute in item['newznab:attr']:
							if 'size' in attribute['_name']:
								jsonSize = int(attribute['_value'])
							elif 'password' in attribute['_name']:
								jsonPassword = int(attribute['_value'])
							elif 'usenetdate' in attribute['_name']:
								jsonAge = attribute['_value']
