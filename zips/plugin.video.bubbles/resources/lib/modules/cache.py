...
def get(function, duration, *args):
	...
	try:
		...
		# Bubbles: sometimes None is returned as a string instead of the special value None.
		invalid = False
		try:
			if not fresh_result:
				invalid = True
		...
		try:
			if fresh_result == 'None' or fresh_result == '' or fresh_result == '[]' or fresh_result == '{}':
				invalid = True
		except: pass
		try:
			if len(fresh_result) == 0:
				invalid = True
		except: pass
